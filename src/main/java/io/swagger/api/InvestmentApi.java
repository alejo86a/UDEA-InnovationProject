...
public interface InvestmentApi {
    ...
    ResponseEntity<Void> registerInvestment(@ApiParam(value = "Invest tot register"  )  @Valid @RequestBody Investment project);
    ...
    ResponseEntity<List<Investment>> searchAllInvestments();
    ...
    @RequestMapping(value = "/investment/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Object> searchInvestment(@ApiParam(value = "id investment to find",required=true) @PathVariable("id") Integer id);
